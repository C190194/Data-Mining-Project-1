...
def cross_validattion_M2_without_pruning(data_path, names_path, minsup=0.01, minconf=0.5):
    ...
    for k in range(len(split_point)-1):
        ...
        # compute the error accuracy and total accuracy rate
        accuracy_rate = calcualte_accuracy(M2, testing_data)
        ...
        print("CBA-CB M2's accuracy rate without rule pruning: %.1lf%%" % (accuracy_rate * 100))
    ...
    print("\nAverage CBA-CB M2's accuracy rate without rule pruning: %.1lf%%" % (total_accuracy_rate / 10 * 100))
...
if __name__ == "__main__":
    ...
    test_data_path = 'C:/Users/XPS/Desktop/Uni drives me crazy/Y3S1/CZ4032 Data Analytics and Mining/Data-Mining-Project-1/dataset/heart.data'
    test_names_path = 'C:/Users/XPS/Desktop/Uni drives me crazy/Y3S1/CZ4032 Data Analytics and Mining/Data-Mining-Project-1/dataset/heart.names'
